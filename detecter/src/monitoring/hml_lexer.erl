...
%% Added by hand to the checked-in leex output: these template helpers are
%% not referenced by this grammar and the file is not regenerated by the build.
-compile({nowarn_unused_function, [{string_gen, 1}, {string_escape, 1}, {escape_char, 1}]}).
